...
if (isset($_POST['name'], $_POST['role'], $_POST['username'], $_POST['password'])) {
    ...
    try {
        ...
        if (empty($nameExist)) {
            ...
            $insertStmt = $conn->prepare("INSERT INTO `tbl_user` (`name`, `role`, `username`, `password`) VALUES (:name, :role, :username)");
            ...
            <script>
                ...
                window.location.href = 'http://localhost:90/gyazproje/endpoint/add-user.php';
            </script>
            ";
        }
